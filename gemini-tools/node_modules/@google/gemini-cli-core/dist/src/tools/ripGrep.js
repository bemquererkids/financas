...
class GrepToolInvocation extends BaseToolInvocation {
    config;
    geminiIgnoreParser;
    constructor(config, geminiIgnoreParser, params, messageBus, _toolName, _toolDisplayName) {
        super(params, messageBus, _toolName, _toolDisplayName);
        this.config = config;
        this.geminiIgnoreParser = geminiIgnoreParser;
    }
...
export class RipGrepTool extends BaseDeclarativeTool {
    ...
    createInvocation(params, messageBus, _toolName, _toolDisplayName) {
        return new GrepToolInvocation(this.config, this.geminiIgnoreParser, params, messageBus ?? this.messageBus, _toolName, _toolDisplayName);
    }
}
