...
import { isWithinRoot, isBinaryFile, detectFileType, processSingleFileContent, detectBOM, readFileWithEncoding, fileExists, readWasmBinaryFromDisk, saveTruncatedContent, } from './fileUtils.js';
  ...
  `;
    ...
    describe('saveTruncatedContent', () => {
        ...
        it('should return content unchanged if below threshold', async () => {
            ...
            const result = await saveTruncatedContent(content, callId, tempRootDir, THRESHOLD, TRUNCATE_LINES);
        ...
        it('should sanitize callId to prevent path traversal', async () => {
            ...
            const expectedFileContent = wrappedLines.join('\n');
            await saveTruncatedContent(content, callId, tempRootDir, THRESHOLD, TRUNCATE_LINES);
