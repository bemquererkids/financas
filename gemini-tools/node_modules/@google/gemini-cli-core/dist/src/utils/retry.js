...
import { TerminalQuotaError, RetryableQuotaError, classifyGoogleError, } from './googleQuotaErrors.js';
...
export async function retryWithBackoff(fn, options) {
    ...
    const cleanOptions = options
        ...
        : {};
    const { maxAttempts, initialDelayMs, maxDelayMs, onPersistent429, authType, shouldRetryOnError, shouldRetryOnContent, retryFetchErrors, signal, getAvailabilityContext, onRetry, } = {
