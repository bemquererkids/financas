...
export type AgentResponse = {
     ...
     */
    result: InitializeResponse | AuthenticateResponse | NewSessionResponse | LoadSessionResponse | ListSessionsResponse | ForkSessionResponse | ResumeSessionResponse | SetSessionModeResponse | PromptResponse | SetSessionModelResponse | ExtResponse;
} | {
    error: _Error;
    id: RequestId;
};
...
export type ClientRequest = {
    id: RequestId;
    method: string;
    params?: InitializeRequest | AuthenticateRequest | NewSessionRequest | LoadSessionRequest | ListSessionsRequest | ForkSessionRequest | ResumeSessionRequest | SetSessionModeRequest | PromptRequest | SetSessionModelRequest | ExtRequest | null;
};
